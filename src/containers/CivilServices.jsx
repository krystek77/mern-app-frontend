  ...
  return (
    <div className="pt-16" ref={ref}>
      <Header
        ...
        images={bgImages}
        title="Wszytsko co niezbędne służbą cywilnym, aby odzież zachowała swoje właściwości gwarantując bezpieczeństwo podczas ciężkiej i niebezpiecznej pracy"
      />
      <main className="pl-8 pr-8">
        <PageTitle text="Przemysłowe urządzenia dla służb cywilnych" />
        <div className="grid xl:grid-cols-1-300 xl:gap-x-6 ">
          <section className="">
            ...
            {data.products.length ? (
              ...
              <NoItems msg="Brak przemysłowych urządzeń pralniczych dedykowanych dla służb cywilnych m.in. straży pożarnej, policji, wojska..." />
            )}
          </section>
          <AsideLinks />
        </div>
